...
// tests for HistoricDecisionOutputInstanceDto
void main() {
  // final instance = HistoricDecisionOutputInstanceDto();

  group('test HistoricDecisionOutputInstanceDto', () {
    ...
    // int ruleOrder
    test('to test the property `ruleOrder`', () async {
      // TODO
    });
