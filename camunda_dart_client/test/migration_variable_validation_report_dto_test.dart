...
// tests for MigrationVariableValidationReportDto
void main() {
  // final instance = MigrationVariableValidationReportDto();

  group('test MigrationVariableValidationReportDto', () {
    ...
    // List<String> failures (default value: const [])
