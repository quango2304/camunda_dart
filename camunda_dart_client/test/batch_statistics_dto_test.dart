...
// tests for BatchStatisticsDto
void main() {
  // final instance = BatchStatisticsDto();

  group('test BatchStatisticsDto', () {
    // The id of the batch.
    // String id
    ...
    // int jobsCreated
    test('to test the property `jobsCreated`', () async {
      // TODO
    });
