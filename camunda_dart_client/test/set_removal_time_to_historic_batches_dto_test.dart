...
// tests for SetRemovalTimeToHistoricBatchesDto
void main() {
  // final instance = SetRemovalTimeToHistoricBatchesDto();

  group('test SetRemovalTimeToHistoricBatchesDto', () {
    ...
    test('to test the property `historicBatchQuery`', () async {
      // TODO
    });

    // The ids of the historic batches to set the removal time for.
    // List<String> historicBatchIds (default value: const [])
    test('to test the property `historicBatchIds`', () async {
      // TODO
    });
