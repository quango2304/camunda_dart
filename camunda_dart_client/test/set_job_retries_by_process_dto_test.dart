...
// tests for SetJobRetriesByProcessDto
void main() {
  // final instance = SetJobRetriesByProcessDto();

  group('test SetJobRetriesByProcessDto', () {
    ...
    // List<String> processInstances (default value: const [])
    test('to test the property `processInstances`', () async {
      // TODO
    });
