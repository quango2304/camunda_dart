...
// tests for DecisionRequirementsDefinitionXmlDto
void main() {
  // final instance = DecisionRequirementsDefinitionXmlDto();

  group('test DecisionRequirementsDefinitionXmlDto', () {
    ...
    // String dmnXml
    test('to test the property `dmnXml`', () async {
      // TODO
    });
