...
// tests for CalledProcessDefinitionDto
void main() {
  // final instance = CalledProcessDefinitionDto();

  group('test CalledProcessDefinitionDto', () {
    ...
    // String diagram
    test('to test the property `diagram`', () async {
      // TODO
    });
    ...
    // String versionTag
    test('to test the property `versionTag`', () async {
      // TODO
    });
    ...
    test('to test the property `historyTimeToLive`', () async {
      // TODO
    });

    // A flag indicating whether the process definition is startable in Tasklist or not.
    // bool startableInTasklist
    test('to test the property `startableInTasklist`', () async {
      // TODO
    });

    // Ids of the CallActivities which call this process.
    // List<String> calledFromActivityIds (default value: const [])
    test('to test the property `calledFromActivityIds`', () async {
      // TODO
    });

    // The id of the calling process definition
    // String callingProcessDefinitionId
    test('to test the property `callingProcessDefinitionId`', () async {
      // TODO
    });
