...
// tests for PasswordPolicyRuleDto
void main() {
  // final instance = PasswordPolicyRuleDto();

  group('test PasswordPolicyRuleDto', () {
    ...
    // Map<String, String> parameter (default value: const {})
    test('to test the property `parameter`', () async {
      // TODO
    });
