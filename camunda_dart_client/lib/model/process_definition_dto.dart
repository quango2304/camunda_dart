...
class ProcessDefinitionDto {
  /// Returns a new [ProcessDefinitionDto] instance.
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ProcessDefinitionDto &&
    other.id == id &&
    other.key == key &&
  ...
  /// Returns a new [ProcessDefinitionDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ProcessDefinitionDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ProcessDefinitionDto[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ProcessDefinitionDto[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ProcessDefinitionDto> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ProcessDefinitionDto>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ProcessDefinitionDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ProcessDefinitionDto> mapFromJson(dynamic json) {
    final map = <String, ProcessDefinitionDto>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ProcessDefinitionDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ProcessDefinitionDto-objects as value to a dart map
  static Map<String, List<ProcessDefinitionDto>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ProcessDefinitionDto>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ProcessDefinitionDto.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
