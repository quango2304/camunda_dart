...
class MigrationPlanDto {
  /// Returns a new [MigrationPlanDto] instance.
  MigrationPlanDto({
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is MigrationPlanDto &&
  ...
  @override
  String toString() => 'MigrationPlanDto[sourceProcessDefinitionId=$sourceProcessDefinitionId, targetProcessDefinitionId=$targetProcessDefinitionId, instructions=$instructions, variables=$variables]';
  ...
  /// Returns a new [MigrationPlanDto] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static MigrationPlanDto? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "MigrationPlanDto[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "MigrationPlanDto[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return MigrationPlanDto(
        ...
        instructions: MigrationInstructionDto.listFromJson(json[r'instructions']),
  ...
  static List<MigrationPlanDto> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <MigrationPlanDto>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = MigrationPlanDto.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, MigrationPlanDto> mapFromJson(dynamic json) {
    final map = <String, MigrationPlanDto>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = MigrationPlanDto.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of MigrationPlanDto-objects as value to a dart map
  static Map<String, List<MigrationPlanDto>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<MigrationPlanDto>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = MigrationPlanDto.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
