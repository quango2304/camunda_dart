...
class ConditionApi {
  ConditionApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;
  ...
  Future<Response> evaluateConditionWithHttpInfo({ EvaluationConditionDto? evaluationConditionDto, }) async {
    // ignore: prefer_const_declarations
    final path = r'/condition';
  ...
  ///
  /// * [EvaluationConditionDto] evaluationConditionDto:
  Future<List<ProcessInstanceDto>?> evaluateCondition({ EvaluationConditionDto? evaluationConditionDto, }) async {
    final response = await evaluateConditionWithHttpInfo( evaluationConditionDto: evaluationConditionDto, );
