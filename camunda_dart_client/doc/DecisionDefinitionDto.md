# openapi.model.DecisionDefinitionDto
...
**historyTimeToLive** | **int** | History time to live value of the decision definition. Is used within [History cleanup](https://docs.camunda.org/manual/7.20/user-guide/process-engine/history/#history-cleanup). | [optional] 
