# openapi.model.ProcessInstanceWithVariablesDto
...
**variables** | [**Map<String, VariableValueDto>**](VariableValueDto.md) | The id of the process instance. | [optional] [default to const {}]
