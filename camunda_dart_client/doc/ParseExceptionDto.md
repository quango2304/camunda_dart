# openapi.model.ParseExceptionDto
...
**details** | [**Map<String, ResourceReportDto>**](ResourceReportDto.md) | A JSON Object containing list of errors and warnings occurred during deployment. | [optional] [default to const {}]
